...
/**
 * description：对流的操作做一次强化和进阶
 * author：dingyawu
 * date：created in 0:04 2020/9/24
 * history:
 */
public class TestPlus {
    ...
    public void test11(){
        List<Employee> data = TestDemo.createData();
        List<Leader> result = data.stream().filter(emp -> emp.getSalary() > 20000).map(emp -> {
    ...
    public void test12(){
        List<Employee> data = TestDemo.createData();
        data.stream().sorted(Comparator.comparing(Employee::getSalary).reversed()).peek(System.out::println).collect(Collectors.toList());
    }
    ...
    public void test15(){
        List<Employee> data = TestDemo.createData();
//        List<Employee> result = Stream.of(data).distinct(Employee::getSalary).collect(Collectors.toList());
//        data.stream().filter(disti);
    ...
    public void test16(){
        ...
        Double result1 = data.stream().map(Employee::getSalary).reduce((a, b) -> {return a + b;}).get();
    ...
    public void test17(){
        ...
        Map<String, Double> result2 = data.stream().collect(Collectors.toMap(Employee::getName, Employee::getSalary));
        System.out.println(result2);
    }
    ...
    public void test19(){
        List<Employee> data = TestDemo.createData();
        DoubleSummaryStatistics statistics = data.stream().collect(Collectors.summarizingDouble(Employee::getSalary));
    ...
    public void test21(){
        List<Employee> data = TestDemo.createData();
        Map<Double, List<Employee>> result = data.stream().collect(Collectors.groupingBy(Employee::getSalary));
        Map<Double, Long> result1 = data.stream().collect(Collectors.groupingBy(Employee::getSalary,
                Collectors.counting()));
        System.out.println(result1);
        Map<Double, Double> result2 = data.stream().collect(Collectors.groupingBy(Employee::getSalary, Collectors.summingDouble(Employee::getSalary)));
        System.out.println(result2);
        Map<Double, List<Employee>> result3 = data.stream().collect(Collectors.groupingBy(Employee::getSalary,
                Collectors.toList()));
        System.out.println(result3);
    }
    @Test
    ...
    public void test23() throws IOException {
        ...
        printWriter.close();
        List<String> result = Files.lines(Paths.get("E:\\txt.txt")).peek(System.out::println).collect(Collectors.toList());
    }
